...
async def ban_kick(bot: CENSURADO, ctx, member: Member, reason: str,
...
async def clean_msg(ctx, bot: CENSURADO, count: int):
    """
...
async def __mute(ctx, bot: CENSURADO, member: Member, muted_role: Role,
...
async def mute_unmute(ctx, bot: CENSURADO, member: Member,
...
async def send_mod_log(ctx, bot: CENSURADO, action: str, member: Member,
...
async def warn_pardon(bot: CENSURADO, ctx, reason: str, member: Member,
                      is_warn: bool):
    """
