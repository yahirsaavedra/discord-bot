    ...
    async def on_command_error(self, context, exception):
        ...
        if 'NotImplementedError' in str(exception):
            s = ("**This command is under construction**\n\n"
                 ...
                 "previous CENSURADO version, all commands and databases has "
                 "been wiped and CENSURADO was switched to a newer rewrite. "
                 ...
                 "Cheers from the CENSURADO's developer team~")
